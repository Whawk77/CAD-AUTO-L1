...
Identity: same pet in every frame: Upgrade the existing approved 咕嘎 pet; preserve its exact identity, pixel-art style, colors, facial construction, silhouette, proportions, and standard animations. Add only the v2 looking-direction system.. Preserve silhouette, face, proportions, markings, palette, material, style, and props.
