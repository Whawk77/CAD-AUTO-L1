...
Use the attached canonical base for identity and the layout guide only for spacing. Same pet in every frame: Upgrade the existing approved 咕嘎 pet; preserve its exact identity, pixel-art style, colors, facial construction, silhouette, proportions, and standard animations. Add only the v2 looking-direction system.. Preserve silhouette, face, palette, material, proportions, markings, and props.
