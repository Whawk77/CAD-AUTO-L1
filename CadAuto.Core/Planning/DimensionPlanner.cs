...
public sealed class DimensionPlanner
{
	...
	private IList<PlannedDimension> BuildBottomStructureWidthDimensions(OutlineFeature2D outline)
	{
		...
		// ponytail: Bottom is a datum side and intentionally does not run the complementary
		// snap/removal path used by Top/Left/Right without a user-confirmed production case.
